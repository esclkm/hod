			...
			<form action="{USERS_EDIT_SEND}" method="post" name="useredit" enctype="multipart/form-data">
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td>{PHP.L.Maingroup}:<br />&nbsp;{PHP.out.img_down}<br /><div class="groupedit">{USERS_EDIT_GROUPS}</div></td>
					</tr>
					<tr>
						<td>{PHP.L.Country}:</td>
...
<!-- ENDIF -->
					...
					<tr>
						...
						<td>{USERS_EDIT_WEBSITE|cot_rc_modify($this, 'class="form-control"')}</td>
					</tr>
					<tr>
						<td>{PHP.skinlang.usersprofile.IRC}</td>
						<td>{USERS_EDIT_IRC|cot_rc_modify($this, 'class="form-control"')}</td>
					</tr>
					<tr>
						<td>{PHP.skinlang.usersprofile.ICQ}</td>
						<td>{USERS_EDIT_ICQ|cot_rc_modify($this, 'class="form-control"')}</td>
					</tr>					
					<tr>
