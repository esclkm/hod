...
<!-- ENDIF -->
					...
					<tr>
						...
						<td>{USERS_PROFILE_WEBSITE|cot_rc_modify($this, 'class="form-control"')}</td>
					</tr>
					<tr>
						<td>{PHP.skinlang.usersprofile.IRC}</td>
						<td>{USERS_PROFILE_IRC|cot_rc_modify($this, 'class="form-control"')}</td>
					</tr>
					<tr>
						<td>{PHP.skinlang.usersprofile.ICQ}</td>
						<td>{USERS_PROFILE_ICQ|cot_rc_modify($this, 'class="form-control"')}</td>
					</tr>
					<tr>
						<td>
							{PHP.L.users_newpass}:
