...
if ($a == 'update')
{
	...
	$rstructure['structure_text_after'] = cot_import('rstructuretext_after', 'P', 'HTM');
...
$t->assign(array(
	...
	'CATDESC_EDIT_TEXT_AFTER' => cot_textarea('rstructuretext_after', $catt["structure_text_after"], 15, 50, '', 'input_textarea_editor'),
	...
	'CATDESC_EDIT_RIGHTS_URL' => cot_url('admin', 'm=rightsbyitem&ic=page&io='.$c),
	'CATDESC_EDIT_OPTIONS_URL' => cot_url('admin', 'm=structure&n='.$n.'&id='.$structure_id.'&'.cot_xg()),
	'CATDESC_EDIT_CONFIG_URL' => cot_url('admin', 'm=config&n=edit&o=module&p=page&sub='.$c),
