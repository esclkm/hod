...
if(/*!$taglatestcomments && */$cfg['plugin']['recentcomments']['commentsperpage'] > 0)
{
	...
	while($row = $sqlcom2->fetch())
	{
		...
		$latestcomments -> assign(array(
			...
			"RECENTCOMMENTS_ROW_DATE" => cot_date('datetime_medium', $row['com_date']),
...
$t->assign(array("PLUGIN_LATESTCOMMENTS" => $taglatestcomments));
